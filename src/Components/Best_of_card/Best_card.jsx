    ...
    <div>
      <Navbar_Strt/>
        ...
        <div className="maped_card">
          <div style={{marginTop:"170px"}}  className="cardPlants_card" key={paramsFindCard?.id}>
            <img data-aos="zoom-in-down" className="cardPlants_card__img" src={paramsFindCard?.pic} alt="" />
            <div className="ggg_card"data-aos="zoom-in-left">
